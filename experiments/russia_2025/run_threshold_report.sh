...
INPUT_FILE="${SCRIPT_DIR}/results/russia_validation_windows.csv"
OUTPUT_FILE="${SCRIPT_DIR}/results/russia_frozen_threshold_metrics.csv"

FROZEN_THRESHOLD="0.73"

if [[ ! -f "${INPUT_FILE}" ]]; then
    echo "Russia validation results not found:" >&2
    echo "  ${INPUT_FILE}" >&2
