...
INPUT_FILE="${SCRIPT_DIR}/results/davao_validation_windows.csv"
OUTPUT_FILE="${SCRIPT_DIR}/results/davao_frozen_threshold_metrics.csv"

if [[ ! -f "${INPUT_FILE}" ]]; then
    echo "Davao validation results not found:" >&2
    echo "  ${INPUT_FILE}" >&2
